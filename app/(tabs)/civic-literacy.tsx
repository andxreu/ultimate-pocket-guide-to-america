...
/**
 * Civic Literacy Screen Component
 * Displays civic literacy content sections and subsections
 */
      ...
      <View style={[styles.errorContainer, { backgroundColor: colors.background }]}>
        ...
        >
          ...
          <Text style={[styles.errorText, { color: colors.textSecondary }]}>
            The civic literacy section could not be loaded. Please try restarting the app.
          </Text>
        </Animated.View>
      </View>
    );

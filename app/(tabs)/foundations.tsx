...
/**
 * Foundations Screen Component
 * Displays foundational documents and principles of American government
 */
      ...
      <View style={[styles.errorContainer, { backgroundColor: colors.background }]}>
        ...
        >
          ...
          <Text style={[styles.errorText, { color: colors.textSecondary }]}>
            The foundations section could not be loaded. Please try restarting the app.
          </Text>
        </Animated.View>
      </View>
    );

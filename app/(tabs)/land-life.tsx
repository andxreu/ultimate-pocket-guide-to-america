...
/**
 * Land and Life Screen Component
 * Displays information about American geography, culture, and daily life
 */
      ...
      <View style={[styles.errorContainer, { backgroundColor: colors.background }]}>
        ...
        >
          ...
          <Text style={[styles.errorText, { color: colors.textSecondary }]}>
            The land and life section could not be loaded. Please try restarting the app.
          </Text>
        </Animated.View>
      </View>
    );

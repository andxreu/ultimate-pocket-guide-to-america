 ...
 * FIXED: Added Glossary tab back for iOS
 */
...
/**
 * iOS Tab Layout Component
 * FIXED: Now uses the same FloatingTabBar as Android/Web with Glossary tab included
 * FIXED: Restored hamburger menu for iOS
 */

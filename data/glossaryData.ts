...
export const glossaryData: GlossoryTerm[] = [
  {
    id: 'amendment',
    term: 'Amendment',
  ...
  },
  {
    ...
    definition: 'The branch of the federal government responsible for enforcing laws, led by the President and supported by federal agencies and departments.',

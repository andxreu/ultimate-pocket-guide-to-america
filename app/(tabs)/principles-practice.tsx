...
/**
 * Principles in Practice Screen Component
 * Displays how core principles are applied in American government
 */
      ...
      <View style={[styles.errorContainer, { backgroundColor: colors.background }]}>
        ...
        >
          ...
          <Text style={[styles.errorText, { color: colors.textSecondary }]}>
            The principles in practice section could not be loaded. Please try restarting the app.
          </Text>
        </Animated.View>
      </View>
    );
